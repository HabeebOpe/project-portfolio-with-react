  ...
  return (
    <div className="header vanilla">
      ...
      <Link to="/"><span className="back-to-home">back to home</span></Link>
        ...
        <p>
          All projects are coded with Javascript mainly while HTML and CSS for structure and designing. Projects in this section are not mainly design projects but are programmed projects.
        </p>
      </div>
